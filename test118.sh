...
Fetching_Signals(){
	...
	mod1=$(egrep -o '\<module\> *([a-Z0=9]+)' $file1 | sed 's/module *//g')
	
#----------------------------------------------------------------#
	
	sed -r ':x;${s/\n/ /g};N;bx'  $file1  | sed -r -e   's/\(//g' -e 's/\)//g'  | sed  -r  -e  's/(.);/\1 ;/g'    -e 's/(\]) *([a-Z]*)/\1\2/g' -e  's/ *, */,/g' -e 's/reg//g' -e 's/logic//g' -e 's/wire//g' -e 's/\[ *([0-9]+) *: *([0-9]+) *\]/\[\1\:\2\]/g'  >  temp_file2
...
#.............................................
	echo "Enter value of repeat_count"
	read  repeat_count
...
#...............................................
         echo "Enter time for toggling the clock:"
 	read tclk	 
	
	echo "Enter delay for ivoke reset :"
	read treset
...
Main_Menu(){
	echo -e "1. Compile the verilog file.\n"
	echo -e "2. Transaction Class.\n"
	echo -e "3. Generator Class.\n"
	echo -e "4. Driver Class.\n"
	echo -e "5. Interface.\n"
	echo -e "6. Environment Class.\n"
	echo -e "7. Random Test.\n"
	echo -e "8. Testbench top module.\n"	
	echo -e "9. Generate complete testbench.\n"
	echo -e "10. Exit\n"
